...
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_AGREGAR_USUARIO TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_ACTUALIZAR_USUARIO TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.LEC_CONSULTAR_USUARIO_ACTIVO TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_ASIGNAR_PLAN_USUARIO TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_REGISTRAR_PAGO TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_CONFIRMAR_PAGO TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.LEC_OBTENER_PAGO_PENDIENTE TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.LEC_TOTAL_PAGO_USUARIO TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_CREAR_SERVIDOR TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_REINICIAR_SERVIDOR TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_ACTUALIZAR_SERVIDOR TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_ELIMINAR_SERVIDOR TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_CREAR_TICKET TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.ESC_CERRAR_TICKET TO 'CLIENTE';
GRANT EXECUTE ON PROCEDURE Voxel_Hosting.LEC_TICKET_POR_USUARIO TO 'CLIENTE';