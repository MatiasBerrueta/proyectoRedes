    ...
    <main>
        <section class="seccion-presentacion">
            <div class="contenedor">
                ...
                <button class="font-size-4 flex-align-items">
                    Empezar ahora 
        ...
        <section class="seccion-tutorial">
            <div class="contenedor">
                ...
                <div>
                    <div class="tutorial-pasos" role="tablist">
                        ...
                        <button role="tab" aria-selected="false" id="tab-5">
                    ...
                    <div class="display-pasos">
                        <img src="" alt="" class="display-paso active">
                        <img src="" alt="" class="display-paso">
                        <img src="" alt="" class="display-paso">
                        <img src="" alt="" class="display-paso">
                    </div>
                </div>
